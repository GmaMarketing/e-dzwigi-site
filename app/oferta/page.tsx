        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              ...
              { meter: "21m", capacity: "do 21M", name: "ELEWACJE I WYCINKA",    specs: "Podnośnik koszowy · udźwig 220kg", image: "/sprzet/podnosniki-21m.webp",      href: "/flota/podnosnik-koszowy-21m" },
            ].map((card) => (
              <Link
                key={card.href}
                href={card.href}

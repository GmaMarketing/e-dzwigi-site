...
const cities = ["Tychy", "Katowice", "Gliwice", "Sosnowiec", "Bielsko-Biała", "Rybnik", "Dąbrowa Górnicza", "Chorzów"];
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        <div>
            ...
            <p className="text-zinc-500 text-lg leading-relaxed mb-10 max-w-md">
                Baza w Tychach, zasięg na cały Śląsk. Dojazd do Katowic, Gliwic, Sosnowca, Rybnika i okolic – zazwyczaj poniżej 60 minut.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                <div className="flex items-start gap-4 p-4 bg-white rounded-xl border border-zinc-100 shadow-sm">
                    ...
                    <div>
                        <span className="block font-bold text-zinc-900 text-sm uppercase">Szybka Reakcja</span>
                ...
                <div className="flex items-start gap-4 p-4 bg-white rounded-xl border border-zinc-100 shadow-sm">
                    ...
                    <div>
                        <span className="block font-bold text-zinc-900 text-sm uppercase">Bezpieczeństwo</span>
            ...
            <div className="flex flex-wrap gap-2">
                {cities.map((city) => (
                    <span key={city} className="px-3 py-1 bg-zinc-100 text-zinc-600 text-xs font-bold uppercase tracking-wide rounded-md">
                        {city}
                    </span>
                ))}
            </div>
        ...
        <div className="relative h-[400px] md:h-[600px] w-full bg-white rounded-3xl border border-zinc-200 shadow-2xl p-4 md:p-8 flex items-center justify-center overflow-hidden">
             ...
             <div className="w-full h-full">
                <ComposableMap
                    ...
                    projectionConfig={{
                        ...
                        center: [19.5 as any, 52 as any] // Center on Poland roughly
                    }}
                ...
                >
                    <Geographies geography={polandGeo}>
                        ...
                        geographies.map((geo, i) => {
                            // Highlight Silesia (Śląskie)
                            const isSilesia = geo.properties.name === "Silesian" || geo.properties.name === "Śląskie" || geo.properties["hc-key"] === "pl-sl";
                            ...
                            return (
                                <Geography
                                    ...
                                    style={{
                                        default: {
                                            fill: isSilesia ? "#fee2e2" : "#f4f4f5", // Red-100 for Silesia, Zinc-100 for others
                    ...
                    {/* Tychy Marker */}
                    <Marker coordinates={[18.99 as any, 50.12 as any]}>
             ...
             <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end pointer-events-none">
                <div className="bg-white/90 backdrop-blur px-4 py-3 rounded-xl border border-zinc-200 shadow-lg">
                    <span className="block text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-1">Baza Główna</span>
